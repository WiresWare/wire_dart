...
var HTMLPanel = function HTMLPanel() {
  var _useAddonState = (0, _api.useAddonState)(_shared.EVENT_CODE_RECEIVED, ''),
  ...
  (0, _api.useChannel)(_defineProperty({}, _shared.EVENT_CODE_RECEIVED, function (_ref) {
    ...
    var _options$prettier = options.prettier,
        prettier = _options$prettier === void 0 ? {} : _options$prettier;

    var prettierConfig = _objectSpread({}, prettier, {
      // Ensure we always pick the html parser
      parser: 'html',
      plugins: [_parserHtml["default"]]
    });

    var code = (0, _standalone.format)(html, prettierConfig);
    setState(code);
  }));
  return /*#__PURE__*/_react["default"].createElement(_react.Fragment, null, /*#__PURE__*/_react["default"].createElement(_SyntaxHighlighter["default"], {
    language: 'html',
    copyable: true,
    padded: true,
